...
@section('content')
    ...
    <form action="{{ route('admin.projects.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="technologies" class="form-control" value="{{ old('technologies') }}" placeholder="Laravel, Bootstrap, MySQL">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="url" name="demo_url" class="form-control" value="{{ old('demo_url') }}">
        </div>
